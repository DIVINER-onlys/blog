...
/*!********************!*\
  !*** ./src/app.ts ***!
  \********************/
/*! exports provided: default, Ebanx */
...
/* harmony import */ var _channel_ebanx_ebanx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/channel/ebanx/ebanx */ "./src/channel/ebanx/ebanx.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Ebanx", function() { return _channel_ebanx_ebanx__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
var PAYSDK = /*#__PURE__*/function () {
  // 全局 SDK 对象
  function PAYSDK(publicKey, initialData) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, PAYSDK);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(PAYSDK, [{
    key: "checkKey",
    value: function checkKey(publicKey) {
    ...
    key: "getToken",
    value: function () {
      var _getToken = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(holderName) {
        var token;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.sdk.getToken(holderName);
    ...
    key: "initSDK",
    value: function () {
      var _initSDK = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.t0 = this.initialData.sdkName;
                _context2.next = _context2.t0 === 'ebanx' ? 5 : 7;
                break;

              case 5:
                // const Ebanx = (await import('@/channel/ebanx/ebanx')).default
                // const Ebanx = require(/* webpackChunkName: "group-foo" */ '@/channel/ebanx/ebanx')
                this.sdk = new _channel_ebanx_ebanx__WEBPACK_IMPORTED_MODULE_5__["default"](this.publicKey, this.initialData);
...
/* harmony default export */ __webpack_exports__["default"] = (PAYSDK); // export {TwoCheckOut, Ebanx}

 // export * from '@/index.d'

/***/ }),

/***/ "./src/channel/ChannelBaseClass.ts":
/*!*****************************************!*\
  !*** ./src/channel/ChannelBaseClass.ts ***!
  \*****************************************/
...
var ChannelBaseClass = /*#__PURE__*/function () {
  function ChannelBaseClass() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ChannelBaseClass);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ChannelBaseClass, [{
    key: "renderToDom",
    value: function renderToDom(html, domId) {
      if (domId.length > 0) {
        document.querySelector("#".concat(domId)).appendChild(html);
      } else {
  ...
  return ChannelBaseClass;
}();

/* harmony default export */ __webpack_exports__["default"] = (ChannelBaseClass);

/***/ }),

/***/ "./src/channel/ebanx/ebanx.ts":
/*!************************************!*\
  !*** ./src/channel/ebanx/ebanx.ts ***!
  \************************************/
/*! exports provided: default */
...
var Ebanx = /*#__PURE__*/function (_ChannelBaseClass) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_11___default()(Ebanx, _ChannelBaseClass);

  var _super = _createSuper(Ebanx);

  function Ebanx(publicKey, initialData) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_9___default()(this, Ebanx);

    _this = _super.call(this);
    _this.publicKey = publicKey;
    _this.initialData = initialData;
    _this.userNameErrorTips = '';
    _this.cardNumberErrorTips = '';
    _this.expirationErrorTips = '';
    _this.cvvErrorTips = '';
    _this.userName = '';
    _this.cardNumber = '';
    _this.expiration = '';
    ...
    _this.loadEBANXJS(); // 加载第三方SDK


    _this.renderHtml(); // 渲染表单


    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_10___default()(Ebanx, [{
    key: "loadEBANXJS",
    value: function loadEBANXJS() {
      var _this$initialData$env,
          _this$initialData,
          _this2 = this;
      ...
      loadjs__WEBPACK_IMPORTED_MODULE_15___default()(["https://js.ebanx.com/assets/songbird/songbird-".concat((_this$initialData$env = (_this$initialData = this.initialData) === null || _this$initialData === void 0 ? void 0 : _this$initialData.env) !== null && _this$initialData$env !== void 0 ? _this$initialData$env : 'dev', ".js"), 'https://js.ebanx.com/ebanx-libjs-latest.min.js'], function () {
        ...
        EBANX.config.setMode(((_this2$initialData = _this2.initialData) === null || _this2$initialData === void 0 ? void 0 : _this2$initialData.env) === 'prod' ? 'production' : 'test');
        EBANX.config.setPublishableKey(_this2.publicKey.key);
        EBANX.config.setCountry(((_this2$initialData2 = _this2.initialData) === null || _this2$initialData2 === void 0 ? void 0 : _this2$initialData2.country) || 'br');
        var time = new Date().getTime() - lasttime;
        (_this2$initialData3 = _this2.initialData) === null || _this2$initialData3 === void 0 ? void 0 : (_this2$initialData3$r = _this2$initialData3.reportSDKLoading) === null || _this2$initialData3$r === void 0 ? void 0 : _this2$initialData3$r.call(_this2$initialData3, {
          time: time
        });
      });
    }
    ...
    value: function () {
      ...
      function changeCardNumber(_x, _x2, _x3) {
        return _changeCardNumber.apply(this, arguments);
      }
    ...
    value: function submit(e) {
      ...
      EBANX.card.createToken({
        ...
        var _ebanxResponse$data, _this3$initialData, _this3$initialData$cr;

        EbanxSubmitBtn.removeAttribute('disabled');

        if (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$data = ebanxResponse.data) === null || _ebanxResponse$data === void 0 ? void 0 : _ebanxResponse$data.hasOwnProperty('status')) {// document.getElementById('status').textContent = 'Success, the token is: ' + ebanxResponse.data.token
        } else {
          var _ebanxResponse$error, _ebanxResponse$error$, _ebanxResponse$error2, _ebanxResponse$error3;

          var errorMessage = (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$error = ebanxResponse.error) === null || _ebanxResponse$error === void 0 ? void 0 : (_ebanxResponse$error$ = _ebanxResponse$error.err) === null || _ebanxResponse$error$ === void 0 ? void 0 : _ebanxResponse$error$.status_message) || (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$error2 = ebanxResponse.error) === null || _ebanxResponse$error2 === void 0 ? void 0 : (_ebanxResponse$error3 = _ebanxResponse$error2.err) === null || _ebanxResponse$error3 === void 0 ? void 0 : _ebanxResponse$error3.message) || '';
          document.getElementById('ebanx_error_tips').textContent = errorMessage;
        }

        (_this3$initialData = _this3.initialData) === null || _this3$initialData === void 0 ? void 0 : (_this3$initialData$cr = _this3$initialData.createToken) === null || _this3$initialData$cr === void 0 ? void 0 : _this3$initialData$cr.call(_this3$initialData, ebanxResponse);
      });
    }
  }, {
    key: "getToken",
    value: function () {
      var _getToken = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_8___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.mark(function _callee2() {
        var _this4 = this;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  var _this4$initialData, _this4$initialData$fi;

                  EBANX.card.createToken({
                    card_number: document.getElementById('ebanx_card_number').value,
                    // card_name: (<HTMLInputElement>document.getElementById('ebanx_user_name')).value,
                    card_name: ((_this4$initialData = _this4.initialData) === null || _this4$initialData === void 0 ? void 0 : (_this4$initialData$fi = _this4$initialData.fieldData) === null || _this4$initialData$fi === void 0 ? void 0 : _this4$initialData$fi.userName) || document.getElementById('ebanx_user_name').value,
                    card_due_date: document.getElementById('ebanx_card_due_date').value,
                    card_cvv: document.getElementById('ebanx_card_cvv').value
                  }, function (ebanxResponse) {
                    var _ebanxResponse$data2;

                    if (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$data2 = ebanxResponse.data) === null || _ebanxResponse$data2 === void 0 ? void 0 : _ebanxResponse$data2.hasOwnProperty('status')) {
                      resolve(ebanxResponse);
                    } else {
                      var _ebanxResponse$error4, _ebanxResponse$error5, _ebanxResponse$error6, _ebanxResponse$error7;

                      var errorMessage = (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$error4 = ebanxResponse.error) === null || _ebanxResponse$error4 === void 0 ? void 0 : (_ebanxResponse$error5 = _ebanxResponse$error4.err) === null || _ebanxResponse$error5 === void 0 ? void 0 : _ebanxResponse$error5.status_message) || (ebanxResponse === null || ebanxResponse === void 0 ? void 0 : (_ebanxResponse$error6 = ebanxResponse.error) === null || _ebanxResponse$error6 === void 0 ? void 0 : (_ebanxResponse$error7 = _ebanxResponse$error6.err) === null || _ebanxResponse$error7 === void 0 ? void 0 : _ebanxResponse$error7.message) || '';
                      document.getElementById('ebanx_error_tips').textContent = errorMessage;
...
/***/ "./src/channel/ebanx/styleObject.ts":
/*!******************************************!*\
  !*** ./src/channel/ebanx/styleObject.ts ***!
  \******************************************/
/*! exports provided: default */
...
var styleObject = function styleObject(styleOption) {
  var commonStyle = styleOption === null || styleOption === void 0 ? void 0 : styleOption.commonStyle;
  var componentStyle = styleOption === null || styleOption === void 0 ? void 0 : styleOption.componentStyle;
  var formStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.formStyle;
  var nameInputStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.nameInputStyle;
  var cardInputStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.cardInputStyle;
  var expirationInputStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.expirationInputStyle;
  var cvvInputStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.cvvInputStyle;
  var btnStyle = componentStyle === null || componentStyle === void 0 ? void 0 : componentStyle.btnStyle;
  var style = {
    // formStyle
    ebanx_payment_form: _objectSpread({
      // background: 'red',
      width: '100%'
    }, formStyle || {}),
    // nameInputStyle
    ebanx_nameInputStyle_inputWrapperStyle: _objectSpread({
      width: '100%',
      margin: '10px 0'
    }, (nameInputStyle === null || nameInputStyle === void 0 ? void 0 : nameInputStyle.inputWrapperStyle) || {}),
    ebanx_nameInputStyle_labelStyle: _objectSpread({
      display: 'block',
      fontWeight: 400,
      fontSize: '15px',
      marginBottom: '8px'
    }, (nameInputStyle === null || nameInputStyle === void 0 ? void 0 : nameInputStyle.labelStyle) || {}),
    ebanx_nameInputStyle_inputStyle: _objectSpread({
      width: '100%',
      padding: '18px 15px',
      borderRadius: '6px',
      color: '#000000',
      ...
      fontSize: '16px',
      outline: 'none'
    }, (nameInputStyle === null || nameInputStyle === void 0 ? void 0 : nameInputStyle.inputStyle) || {}),
    ebanx_nameInputStyle_messageStyle: {},
    // cardInputStyle
    ebanx_cardInputStyle_inputWrapperStyle: _objectSpread({
      width: '100%',
      margin: '10px 0'
    }, (cardInputStyle === null || cardInputStyle === void 0 ? void 0 : cardInputStyle.inputWrapperStyle) || {}),
    ebanx_cardInputStyle_labelStyle: _objectSpread({
      display: 'block',
      fontWeight: 400,
      fontSize: '15px',
      marginBottom: '8px'
    }, (cardInputStyle === null || cardInputStyle === void 0 ? void 0 : cardInputStyle.labelStyle) || {}),
    ebanx_cardInputStyle_inputStyle: _objectSpread({
      width: '100%',
      padding: '18px 15px',
      borderRadius: '6px',
      color: '#000000',
      ...
      fontSize: '16px',
      outline: 'none'
    }, (cardInputStyle === null || cardInputStyle === void 0 ? void 0 : cardInputStyle.inputStyle) || {}),
    ...
    ebanx_expirationInputStyle_inputWrapperStyle: _objectSpread({
      width: '48%',
      margin: '10px 0'
    }, (expirationInputStyle === null || expirationInputStyle === void 0 ? void 0 : expirationInputStyle.inputWrapperStyle) || {}),
    ebanx_expirationInputStyle_labelStyle: _objectSpread({
      display: 'block',
      fontWeight: 400,
      fontSize: '15px',
      marginBottom: '8px'
    }, (expirationInputStyle === null || expirationInputStyle === void 0 ? void 0 : expirationInputStyle.labelStyle) || {}),
    ebanx_expirationInputStyle_inputStyle: _objectSpread({
      width: '100%',
      padding: '18px 15px',
      borderRadius: '6px',
      color: '#000000',
      ...
      fontSize: '16px',
      outline: 'none'
    }, (expirationInputStyle === null || expirationInputStyle === void 0 ? void 0 : expirationInputStyle.inputStyle) || {}),
    ebanx_expirationInputStyle_messageStyle: {},
    // cvvInputStyle
    ebanx_cvvInputStyle_inputWrapperStyle: _objectSpread({
      width: '48%',
      margin: '10px 0'
    }, (cvvInputStyle === null || cvvInputStyle === void 0 ? void 0 : cvvInputStyle.inputWrapperStyle) || {}),
    ebanx_cvvInputStyle_labelStyle: _objectSpread({
      display: 'block',
      fontWeight: 400,
      fontSize: '15px',
      marginBottom: '8px'
    }, (cvvInputStyle === null || cvvInputStyle === void 0 ? void 0 : cvvInputStyle.labelStyle) || {}),
    ebanx_cvvInputStyle_inputStyle: _objectSpread({
      width: '100%',
      padding: '18px 15px',
      borderRadius: '6px',
      color: '#000000',
      ...
      fontSize: '16px',
      outline: 'none'
    }, (cvvInputStyle === null || cvvInputStyle === void 0 ? void 0 : cvvInputStyle.inputStyle) || {}),
    ebanx_cvvInputStyle_messageStyle: {},
    ebanx_error_tips: _objectSpread(_objectSpread(_objectSpread(_objectSpread({
      marginTop: '-10px',
      lineHeight: '18px',
      minHeight: '20px',
      // background: 'pink',
      color: 'red'
    }, (nameInputStyle === null || nameInputStyle === void 0 ? void 0 : nameInputStyle.messageStyle) || {}), (cardInputStyle === null || cardInputStyle === void 0 ? void 0 : cardInputStyle.messageStyle) || {}), (expirationInputStyle === null || expirationInputStyle === void 0 ? void 0 : expirationInputStyle.messageStyle) || {}), (cvvInputStyle === null || cvvInputStyle === void 0 ? void 0 : cvvInputStyle.messageStyle) || {}),
    // btn
    ebanx_submit_btn: _objectSpread({
      width: '100%',
      color: '#ffffff',
      padding: '15px',
      fontSize: '16px',
      opacity: 1,
      background: (btnStyle === null || btnStyle === void 0 ? void 0 : btnStyle.disableBackground) || (btnStyle === null || btnStyle === void 0 ? void 0 : btnStyle.background) || '#dddddd',
      outline: 'none',
      border: '0px',
      borderRadius: '6px'
    }, btnStyle)
...
/*!***************************!*\
  !*** ./src/util/index.ts ***!
  \***************************/
/*! exports provided: checkEbanxUserName, checkoutCardNumber, checkEbanxExpiration, checkCVV */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkEbanxUserName", function() { return checkEbanxUserName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkoutCardNumber", function() { return checkoutCardNumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkEbanxExpiration", function() { return checkEbanxExpiration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkCVV", function() { return checkCVV; });
...
function checkEbanxUserName(userName) {
...
function checkoutCardNumber(cardNumber) {
  /**
   * 模10算法参考
   * https://gist.github.com/tonyc726/60ad6a229b582c6791d7
   */
  // 卡号字符串化并去除空格，仅保留数字
  var strDigits = (cardNumber + '').replace(/[\D]/g, ''); // 银行卡号必须为12-19位数字
  ...
  var luhnDigits = strDigits.split('').reverse(); // 取第1位作为后续的验证号码

  var luhnCheckcode = parseInt(luhnDigits.shift(), 10);
  var loopLength = luhnDigits.length;
  var loopIndex = loopLength;
  var luhnSum = 0;

  for (; loopIndex > 0; loopIndex--) {
    var _i = loopLength - loopIndex,
        _k = parseInt(luhnDigits[_i], 10);

    var _add_val = _k; // 偶数字段 需要*2，并且大于10的数字要相加2个位数的值
  ...
  var luhnSum9 = luhnSum * 9;
  var luhnSum9LastCode = parseInt((luhnSum9 + '').replace(/\d+(\d$)/, '$1'), 10);
  return luhnSum9LastCode === luhnCheckcode; // return /^\d{12,19}$/.test(cardNumber)
}
function checkEbanxExpiration(expiration) {
  ...
  var timeArr = expiration.split('/');
  var customYear = Number(timeArr[1]);
  var customMonth = Number(timeArr[0]);
